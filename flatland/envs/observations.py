...
class TreeObsForRailEnvExtended(ObservationBuilder):
    """
    ...
    def get(self, handle: int = 0) -> Node:
        ...
        root_node_observation = TreeObsForRailEnvExtended.Node(dist_own_target_encountered=0, dist_other_target_encountered=0,
    ...
    def _explore_branch(self, handle, position, direction, tot_dist, depth):
        ...
        node = TreeObsForRailEnvExtended.Node(dist_own_target_encountered=own_target_encountered,
    ...
    def print_node_features(node: Node, label, indent):
        print(indent, "Direction ", label, ": ", node.dist_own_target_encountered, ", ",
              ...
              node.num_agents_ready_to_depart, ",", node.time_step, ",", node.release_date, ",", node.deadline)
