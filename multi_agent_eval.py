# This file is used to calculate the variables fro evaluation of multi-agent RL
...
from utils.environment_utils import create_multi_agent_rail_env
...
def evaluate(seed=37429879, timed=False, filename="./rl-weights.pth", debug=False, refresh=1):
    ...
    env, max_steps, _, _, observation_tree_depth, _ = create_multi_agent_rail_env(seed + 1, timed)
